                ...
                <div class="img-grid-block pad-btm-3">
                    <?php
                        ...
                        for($i = 0; $i < $count; $i ++) {
                            if($i % 3 == 0) {
                                $column1 .= "
                                    <a href=\"images/portfolio/wedding/" . ($i + 1) . ".jpg\" data-lightbox=\"Vows & Phereys\" data-title=\"\">
                                        <img src=\"images/portfolio/wedding/" . ($i + 1) . ".jpg\" title=\"\" alt=\"\">
                                    </a>
                                ";
                            }
                            else if($i % 3 == 1) {
