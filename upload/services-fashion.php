<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        for($i = 0; $i < $col_count; $i ++) {
            $target_dir = "../images/services/fashion/";
            $file_serial = $cols[$i];
    ...
    alert("UPDATE Successful");
        function redirect() {
            window.location = "../upload/services-fashion";
        }
    ...
    <?php
        ...
        $count = $meta['services']['fashion']['section'];
    }
...
<html>
    ...
    <body>
        ...
        <main class="container">
            <form class="" action="services-fashion.php" method="post" enctype="multipart/form-data">
                        ...
                        $display .= "
                            <div class=\"row\">
                                <div class=\"col-12 pos-rel\">
                                    <img class=\"img-res\" src=\"../images/services/fashion/" . ($i + 1) . ".jpg\" alt=\"\" />
