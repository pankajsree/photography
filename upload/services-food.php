<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        for($i = 0; $i < $col_count; $i ++) {
            $target_dir = "../images/services/food/";
            $file_serial = $cols[$i];
    ...
    alert("UPDATE Successful");
        function redirect() {
            window.location = "../upload/services-food";
        }
    ...
    <?php
        ...
        $count = $meta['services']['food']['section'];
    }
...
<html>
    <head>
        <title>Modify Food Services</title>
        <?= $head ?>
        <style>
            main {
                padding-top: 5rem;
    ...
    <body>
        ...
        <main class="container">
            <form class="" action="services-food.php" method="post" enctype="multipart/form-data">
                        ...
                        $display .= "
                            <div class=\"row\">
                                <div class=\"col-12 pos-rel\">
                                    <img class=\"img-res\" src=\"../images/services/food/" . ($i + 1) . ".jpg\" alt=\"\" />
