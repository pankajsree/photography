<?php
    ...
    alert("UPDATE Successful");
        function redirect() {
            window.location = "../upload/portfolio-food";
        }
    ...
    <?php
        ...
        $count = $meta['portfolio']['food']['count'];
    }
...
<html>
    <head>
        <title>Modify Food Portfolio</title>
        <?= $head ?>
        <style>
            main {
                padding-top: 5rem;
    ...
    <body>
        ...
        <main class="container">
            <form class="" action="portfolio-food.php" method="post" enctype="multipart/form-data">
                    ...
                    for($i = 0; $i < $count; $i ++) {
                        ...
                        $display .= "
                            <div class=\"col-4 pos-rel\">
                                <img class=\"img-res\" src=\"../images/portfolio/food/" . ($i + 1) . ".jpg\" alt=\"\" />
