    ...
    <body>
        ...
        <main class="container">
            <form class="" action="home.php" method="post" enctype="multipart/form-data">
                ...
                <input type="file" accept="image/jpeg" id="imgh2" class="accept-img-h d-none" data-serial="2" name="2" />
                ...
                <input type="file" accept="image/jpeg" id="imgh3" class="accept-img-h d-none" data-serial="3" name="3" />
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                //     // alert(updated_col_2 + "---" + updated_col);
                // });
            });
