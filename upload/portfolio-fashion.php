<?php
    ...
    alert("UPDATE Successful");
        function redirect() {
            window.location = "../upload/portfolio-fashion";
        }
    ...
    <?php
        ...
        $count = $meta['portfolio']['fashion']['count'];
    }
...
<html>
    <head>
        <title>Modify Fashion Portfolio</title>
        <?= $head ?>
        <style>
            main {
                padding-top: 5rem;
    ...
    <body>
        ...
        <main class="container">
            <form class="" action="portfolio-fashion.php" method="post" enctype="multipart/form-data">
                    ...
                    for($i = 0; $i < $count; $i ++) {
                        ...
                        $display .= "
                            <div class=\"col-4 pos-rel\">
                                <img class=\"img-res\" src=\"../images/portfolio/fashion/" . ($i + 1) . ".jpg\" alt=\"\" />
