<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        for($i = 0; $i < $col_count; $i ++) {
            $target_dir = "../images/services/wedding/";
            $file_serial = $cols[$i];
    ...
    alert("UPDATE Successful");
        function redirect() {
            window.location = "../upload/services-wedding";
        }
    ...
    <?php
        ...
        $count = $meta['services']['wedding']['section'];
    }
...
<html>
    <head>
        <title>Modify Wedding Services</title>
        <?= $head ?>
        <style>
            main {
                padding-top: 5rem;
    ...
    <body>
        ...
        <main class="container">
            <form class="" action="services-wedding.php" method="post" enctype="multipart/form-data">
                        ...
                        $display .= "
                            <div class=\"row\">
                                <div class=\"col-12 pos-rel\">
                                    <img class=\"img-res\" src=\"../images/services/wedding/" . ($i + 1) . ".jpg\" alt=\"\" />
