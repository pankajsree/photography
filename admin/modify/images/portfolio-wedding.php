<?php
    ...
    if(isset($_POST['updated_col'])) {
        ...
        for($i = 0; $i < $col_count; $i ++) {
            $target_dir = "../../../images/portfolio/wedding/wed/";
            $file_serial = $cols[$i];
        ...
        for($i = 0; $i < $col_count_2; $i ++) {
            $target_dir_2 = "../../../images/portfolio/wedding/wed/square/";
    ...
    alert("UPDATE Successful");
        function redirect() {
            window.location = "portfolio-wedding";
        }
    ...
    <?php
        ...
        $query = "SELECT `p_wedding` FROM `images` WHERE `serial` = 1";
                        ...
                        $display .= "
                            <div class=\"row\">
                                <div class=\"col-12 pos-rel\">
                                    <img class=\"img-res\" src=\"../../../images/portfolio/wedding/wed/square/" . ($i + 1) . ".jpg\" alt=\"\" />
