<?php
    ...
    if(isset($_POST['updated_col'])) {
        ...
        for($i = 0; $i < $col_count; $i ++) {
            $target_dir = "../../../images/portfolio/food/";
            $file_serial = $cols[$i];
        ...
        for($i = 0; $i < $col_count_2; $i ++) {
            $target_dir_2 = "../../../images/portfolio/food/square/";
        ...
        <body>
            <script>
                Swal.fire({
                    ...
                    window.location = "portfolio-food";
                });
            </script>
        </body>
    </html>
    ...
    <?php
        ...
        $query = "SELECT `p_food` FROM `images` WHERE `serial` = 1";
    ...
    <body>
        ...
        <main class="container">
            ...
            <form class="" action="" method="post" enctype="multipart/form-data">
                ...
                <h2 class="mid-line"><span class="text">Food Portfolio</span></h2>
                <?php
                    $display = "";
                    for($i = 0; $i < $count; $i ++) {
                        $display .= "
                            <div class=\"row\">
                                <div class=\"col-12 pos-rel\">
                                    <img class=\"img-res\" src=\"../../../images/portfolio/food/square/" . ($i + 1) . ".jpg\" alt=\"\" />
